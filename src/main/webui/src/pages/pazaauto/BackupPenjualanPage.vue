            ...
            <template v-slot:after>
                <div class="q-pa-md scroll" style="height: 100%">
                    ...
                    <q-form class="q-gutter-md" @submit="handleSave">
                        ...
                        <div class="q-mb-lg">
                            <div class="text-subtitle text-weight-bold text-grey-8 q-mb-sm">{{ $t('pages.penjualanPage.invoiceInfoLabel') }}</div>
                              ...
                              <div class="col-12">
                                ...
                                <div class="col-12">
                                    <!-- <q-select v-model="formData.metodePembayaran"
                                        :options="['CASH', 'TRANSFER', 'DEBIT', 'KREDIT']" :label="$t('pages.penjualanPage.paymentMethodLabel')"
