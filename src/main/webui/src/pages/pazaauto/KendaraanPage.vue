...
const deleteItem = async () => {
  try {
    ...
    // Try to extract meaningful message from exception details
    if (errorMessage.includes('IllegalStateException')) {
      const match = errorMessage.match(/Cannot delete kendaraan[^.]*/)
      if (match) {
