...
class SystemParameterServiceTest {
    ...
    @Mock
    PanacheQuery<SystemParameterEntity> sortedQuery;
    ...
    class CrudTests {
        ...
        void findByIdNotFound() {
            ...
            assertThrows(EntityNotFoundException.class, () -> systemParameterService.findById(999L));
        }
        ...
        void update() {
            ...
            when(repository.getEntityManager().merge(any(SystemParameterEntity.class))).thenReturn(testEntity);

            SystemParameterEntity result = systemParameterService.update(1L, testEntity);
        ...
        void updateNotFound() {
            when(repository.findByIdOptional(999L)).thenReturn(Optional.empty());
            assertThrows(EntityNotFoundException.class, () -> systemParameterService.update(999L, testEntity));
        }
        ...
        void deleteNotFound() {
            ...
            assertThrows(EntityNotFoundException.class, () -> systemParameterService.delete(999L));
        }
    }
    ...
    void findPaginated_sortedSearchAscending() {
        ...
        systemParameterService.findPaginated(pr);
    ...
    void findPaginated_sortedNoSearch() {
        ...
        assertEquals(2L, systemParameterService.findPaginated(pr).getRowsNumber());
    ...
    void findPaginated_emptySearchAndSort() {
        ...
        assertEquals(1L, systemParameterService.findPaginated(pr).getRowsNumber());
